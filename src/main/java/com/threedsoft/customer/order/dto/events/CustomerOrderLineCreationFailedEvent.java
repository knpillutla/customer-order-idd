...
@NoArgsConstructor
@Data
public class CustomerOrderLineCreationFailedEvent extends ExceptionEvent {
	public CustomerOrderLineCreationFailedEvent(CustomerOrderLineCreationRequestDTO req, String serviceName,
			String errorMsg) {
	...
	public CustomerOrderLineCreationFailedEvent(CustomerOrderLineCreationRequestDTO req, String serviceName, String errorMsg, Exception exObj,
			Map headerMap) {
		super("CustomerOrderLineCreationFailedEvent", req.getBusName(), req.getLocnNbr(), "", "", "",
