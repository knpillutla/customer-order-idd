...
@NoArgsConstructor
@Data
public class CustomerOrderCreatedEvent extends WMSEvent {
	public CustomerOrderCreatedEvent(CustomerOrderResourceDTO customerOrderDTO, String serviceName) {
		this(customerOrderDTO, serviceName, null);
	}

	public CustomerOrderCreatedEvent(CustomerOrderResourceDTO customerOrderDTO, String serviceName, Map headerMap) {
		super("CustomerOrderCreatedEvent", customerOrderDTO.getBusName(), customerOrderDTO.getLocnNbr(),
